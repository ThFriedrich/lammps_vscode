        ...
        if (hover_conf.Enabled) {
            ...
            if (docs) {
                ...
                if (docs === null || docs === void 0 ? void 0 : docs.short_description) {
                    content.appendMarkdown((yield math_render_1.getMathMarkdown(docs.short_description)) + ". [Read more... ](https://lammps.sandia.gov/doc/" + (docs === null || docs === void 0 ? void 0 : docs.html_filename) + ")\n");
                ...
                if (docs === null || docs === void 0 ? void 0 : docs.syntax) {
                    ...
                    content.appendMarkdown((yield math_render_1.getMathMarkdown(docs === null || docs === void 0 ? void 0 : docs.parameters)) + "\n\n");
                }
                ...
                if ((docs === null || docs === void 0 ? void 0 : docs.description) && hover_conf.Detail == 'Complete') {
                    ...
                    content.appendMarkdown(math_render_1.mdBeautify(yield math_render_1.getMathMarkdown(docs.description)) + "\n");
                }
